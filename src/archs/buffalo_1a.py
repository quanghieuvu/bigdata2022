...
class Arch(nn.Module):
    def __init__(self, output_depth=3, skip_connection=True):
        ...
        self.mid5 = mid_conv_layer(RESNET_DEPTH_5, 512) #5
        self.mid6 = mid_conv_layer(512, MIDDLE_DEPTH) #5
    ...
    def forward(self, x):
        ...
        feature_map5a = self.mid5(conv_out5)
        feature_map5 = self.mid6(feature_map5a)
        # print ('image feature_map5', feature_map5.size())
        ...
        global_feature = self.AvgPool2d(feature_map5a)
